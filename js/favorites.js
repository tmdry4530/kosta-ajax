  ...
  function renderFavoritesPage() {
    ...
    $.each(favorites, function(_, item) {
      var cardHtml = [
        ...
        '        <p>☎ ' + app.utils.escapeHtml(item.phone || '전화번호 없음') + '</p>',
        '        <p>🏷️ ' + app.utils.escapeHtml(item.category_name || '카테고리 정보 없음') + '</p>',
        '        <p>📅 저장일: ' + app.utils.escapeHtml(app.utils.formatSavedDate(item.saved_at)) + '</p>',
        '      </div>',
        '    </div>',
